...
local on_attach = function(client, bufnr)
  ...
  buf_set_keymap(bufnr, 'n', '<space>ge', '<cmd>lua vim.lsp.diagnostic.show_line_diagnostics()<CR>')
  buf_set_keymap(bufnr, 'n', '<space>gp', '<cmd>lua vim.lsp.diagnostic.goto_prev()<CR>')
  buf_set_keymap(bufnr, 'n', '<space>gn', '<cmd>lua vim.lsp.diagnostic.goto_next()<CR>')
